...
export default function Home() {
  return (
    <div>
        <div className="relative bg-[#F8F7F3] w-full h-screen overflow-hidden">
        <Image
          src="/landingpic.png"
          alt="Landing Image"
          width={1920}
        ...
        />
          ...
          <div className="absolute top-1/4 left-4 md:left-18 text-white max-w-[600px] px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="regis-page-1" passHref>
                <button className="bg-transparent border border-[#F8BE12] text-[#F8BE12] font-semibold px-6 py-3 rounded-full hover:bg-[#F8BE12] hover:text-blue-900 transition-all duration-200 w-full sm:w-auto">
      ...
      <div class="py-30 px-10 bg-[#F8F7F3] overflow-x-hidden">
      ...
      <div className="py-30 px-10 bg-[#F8F7F3] overflow-x-hidden">
      ...
      <section className="py-16 px-6 bg-[#F8F7F3]">
